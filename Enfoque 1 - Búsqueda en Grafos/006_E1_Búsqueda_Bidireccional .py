...
# Este programa implementa la búsqueda bidireccional, que busca
# un camino desde el nodo inicial hasta el nodo objetivo empezando
# desde ambos extremos al mismo tiempo. La idea es que se encuentren
# en algún punto del medio, lo que hace que a veces sea más rápido
# que la BFS normal.
