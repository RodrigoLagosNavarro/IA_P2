...
# Esta clase modela un sistema estocástico con estados ocultos y observables,
# usando un modelo de transición entre estados y un modelo de emisión de observaciones.
