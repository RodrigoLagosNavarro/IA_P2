# ============================================================
# Enfoque 1: Aprendizaje por refuerzo activo
# Autor: Rodrigo Lagos Navarro - Grupo 6E 2P
# ============================================================

# Este enfoque aprende una política óptima explorando el entorno,
# actualizando valores Q para cada estado-acción mediante la ecuación de Bellman.
...
class ActiveReinforcementLearning:
    ...
    def select_action(self, state, epsilon=0.1):
        # Explorar con probabilidad epsilon, si no, explotar mejor acción conocida
    ...
    def update_q_value(self, state, action, reward, next_state):
        # Actualización Q: Q(s,a) <- Q(s,a) + (R + γ * max_a' Q(s',a') - Q(s,a))
    ...
    def sample_next_state(self, state, action):
        # Selección de siguiente estado basada en la probabilidad de transición
