...
# Este programa implementa el algoritmo A*, un método de búsqueda
# informada que utiliza una función heurística para encontrar el
# camino más corto desde un nodo inicial hasta un nodo objetivo.
#
# A* combina:
#   - El costo acumulado desde el inicio (g)
#   - La estimación del costo restante hasta la meta (h)
# La función de evaluación total es f(n) = g(n) + h(n)
#
# En este ejemplo, la heurística usada es la distancia absoluta
# entre el nodo actual y el objetivo: heuristic(a, b) = |a - b|.
...
# ============================================================
# CLASE NODE: REPRESENTA CADA NODO EN EL GRAFO
# ============================================================
class Node:
...
# ============================================================
# CLASE GRAPH: ESTRUCTURA DE DATOS PARA REPRESENTAR EL GRAFO
# ============================================================
class Graph:
    def __init__(self):
...
# ============================================================
# ALGORITMO A* (BÚSQUEDA CON HEURÍSTICA)
# ============================================================
