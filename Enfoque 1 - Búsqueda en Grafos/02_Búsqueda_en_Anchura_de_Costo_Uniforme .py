...
# En este programa se implementa una búsqueda en anchura (BFS),
# también llamada de costo uniforme cuando los caminos tienen
# el mismo costo. El objetivo es encontrar la ruta más corta
# desde un nodo inicial hasta un nodo objetivo dentro de un grafo.
