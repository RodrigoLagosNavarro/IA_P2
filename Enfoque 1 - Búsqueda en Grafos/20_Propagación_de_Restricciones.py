...
# Este código implementa un CSP usando backtracking dirigido por conflictos.
# Permite "saltar atrás" a la variable responsable de un conflicto, evitando
# recorrer ramas que ya sabemos que no producirán solución.
