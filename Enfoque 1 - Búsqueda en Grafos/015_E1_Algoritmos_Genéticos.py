...
# Este código implementa un algoritmo genético para encontrar la mejor solución
# explorando una población de individuos, aplicando selección, cruce y mutación
