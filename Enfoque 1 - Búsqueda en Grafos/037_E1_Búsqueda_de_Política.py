...
# Calcula la política óptima en un MDP mediante iteración de política.
# Evalúa el valor de cada estado según la política actual, luego mejora la política
# seleccionando la acción que maximiza el valor esperado. Repite hasta convergencia.
