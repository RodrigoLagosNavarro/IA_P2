...
# Es una mezcla entre la búsqueda en anchura (BFS) y la profundidad (DFS).
# Básicamente, hace varias búsquedas en profundidad pero aumentando el límite
# cada vez. Así, primero busca a nivel 0, luego a nivel 1, luego a nivel 2, etc.,
# hasta que encuentra el objetivo. Es más eficiente que DFS en algunos casos
# porque evita quedarse atascado en ramas muy profundas.
