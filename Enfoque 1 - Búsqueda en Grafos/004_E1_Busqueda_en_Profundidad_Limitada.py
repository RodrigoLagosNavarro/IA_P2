...
# En este programa se realiza una búsqueda en profundidad limitada.
# Es como una búsqueda en profundidad normal, pero con un límite
# de niveles a los que se puede bajar. Esto evita que el algoritmo
# se quede explorando caminos infinitos o muy largos innecesariamente.
