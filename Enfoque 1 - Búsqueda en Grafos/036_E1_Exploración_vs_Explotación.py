...
# Este código implementa un problema de bandido multi-brazo usando la estrategia ε-greedy.
# Con probabilidad ε, el algoritmo explora eligiendo un brazo aleatorio para descubrir nuevas recompensas.
# Con probabilidad 1-ε, explota el brazo con la mayor recompensa promedio conocida.
# Se actualizan de manera incremental los valores promedio de cada brazo y se simula el proceso durante varias rondas,
# mostrando cómo se balancea la exploración con la explotación.
